...
def train(args):
    ...
    encoder_config = BertConfig(
        ...
        max_position_embeddings=1536,  # Updated to match your sequence length
    ...
    encoder_decoder_config.encoder.hidden_size = 768
    encoder_decoder_config.encoder.intermediate_size = 3072
    encoder_decoder_config.encoder.max_length = MAX_LENGTH
    encoder_decoder_config.encoder.max_position_embeddings = MAX_LENGTH
    encoder_decoder_config.encoder.num_attention_heads = 12
    encoder_decoder_config.encoder.num_hidden_layers = 12
    ...
    encoder_decoder_config.decoder.hidden_size = 768
    encoder_decoder_config.decoder.intermediate_size = 3072
    encoder_decoder_config.decoder.max_length = MAX_LENGTH
    encoder_decoder_config.decoder.max_position_embeddings = MAX_LENGTH
    encoder_decoder_config.decoder.num_attention_heads = 12
    encoder_decoder_config.decoder.num_hidden_layers = 12
    ...
    torch.save(model.state_dict(), "output/model_pretrained.pth")
